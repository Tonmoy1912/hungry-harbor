...
export default function page() {
  ...
  return (
    <div className='py-14 px-10 w-full bg-black text-white flex flex-col gap-4 justify-start items-start'>
      ...
      <p>
        You means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable. Company (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to {website}.
      </p>
      ...
      <p>
        Some of data generated or provided by You or Our Services may be removed or deleted if required (for example, Your old order details or notification may be deleted to reduce storage requirement).
      </p>
