...
export function FilterBar() {
    ...
    return (
        <Fragment>
            <div className=' bg-blue-500 text-white shadow-md shadow-blue-500 border border-blue-900 w-11/12 mx-auto mt-2 p-2 flex flex-col gap-3 items-center  md:flex-row md:justify-between md:items-center rounded-md mb-0.5'>
